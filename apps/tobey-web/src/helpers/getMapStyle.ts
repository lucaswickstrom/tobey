export const getMapStyle = (buildings: number[]) => ({
  version: 8,
  lights: [
    {
      id: 'ambient',
  ...
  fog: {
    ...
    'horizon-blend': ['interpolate', ['exponential', 1.2], ['zoom'], 5, 0.01, 7, 0.03],
    'star-intensity': [
      'interpolate',
      ['exponential', 1.2],
      ['zoom'],
      ...
      0.2,
      7,
      ['interpolate', ['exponential', 1.2], ['measure-light', 'brightness'], 0.1, 0.1, 0.3, 0],
    ],
  },
  ...
  sources: {
    ...
    trees: { type: 'vector', url: 'mapbox://mapbox.mapbox-models-v1' },
    '3dbuildings': {
      type: 'batched-model',
  ...
  layers: [
    {
      ...
      paint: {
        ...
        'background-emissive-strength': ['interpolate', ['linear'], ['zoom'], 13, 0.1, 14, 0],
      },
    },
    {
      id: 'landcover',
      ...
      layout: {},
      paint: {
        'fill-emissive-strength': ['interpolate', ['linear'], ['zoom'], 2, 0.4, 4, 0.25],
        'fill-color': [
          'match',
          ['get', 'class'],
          'wood',
    ...
    },
    {
      ...
      paint: {
        ...
        'fill-opacity': ['interpolate', ['linear'], ['zoom'], 5, 0, 6, 0.6, 12, 0.2],
      },
    },
    {
      ...
      paint: {
        ...
        'fill-opacity': [
          ...
          [
            ...
            1,
            ['interpolate', ['linear'], ['measure-light', 'brightness'], 0.1, 0.8, 0.4, 1],
          ],
        ],
    ...
    },
    {
      ...
      paint: {
        ...
        'fill-opacity': ['interpolate', ['linear'], ['zoom'], 14, 1, 16, 0],
        'fill-antialias': false,
      },
    },
    {
    ...
    },
    {
      ...
      paint: {
        ...
        'fill-emissive-strength': ['interpolate', ['linear'], ['zoom'], 5, 0.1, 7, 0],
      },
    },
    {
      id: 'water-depth',
    ...
    },
    {
      ...
      filter: [
        ...
        ['==', ['get', 'structure'], 'tunnel'],
        ['==', ['get', 'class'], 'path'],
        ['match', ['get', 'type'], ['hiking', 'mountain_bike', 'trail'], true, false],
        ['==', ['geometry-type'], 'LineString'],
      ],
      layout: { 'line-cap': ['step', ['zoom'], 'butt', 16, 'round'] },
      paint: {
        'line-emissive-strength': 0.2,
        'line-width': ['interpolate', ['exponential', 1.5], ['zoom'], 12, 0, 18, 8, 22, 100],
    ...
    },
    {
      ...
      paint: {
        'line-emissive-strength': ['interpolate', ['linear'], ['zoom'], 13, 0.3, 14, 0.5],
        'line-color': [
          'interpolate',
          ['linear'],
          ['zoom'],
    ...
    },
    {
      ...
      paint: {
        ...
        'fill-opacity': ['interpolate', ['linear'], ['zoom'], 16, 0, 17, 0.2],
      },
    },
    {
      id: 'road-path-bg',
      ...
      paint: {
        ...
        'line-width': ['interpolate', ['exponential', 1.5], ['zoom'], 14, 0.5, 18, 1, 22, 2],
        'line-color': 'hsl(0, 10%, 80%)',
        'line-gap-width': ['interpolate', ['exponential', 1.5], ['zoom'], 12, 0, 18, 8, 22, 100],
      },
    },
    {
      id: 'road-steps-bg',
    ...
    },
    {
      ...
      layout: { visibility: 'none' },
      paint: {
        'fill-color': 'hsl(224, 25%, 80%)',
        'fill-outline-color': 'hsl(221, 20%, 70%)',
      },
    },
    {
    ...
    },
    {
      ...
      filter: [
        'all',
        ['match', ['get', 'class'], ['turning_circle', 'turning_loop'], true, false],
        ['==', ['geometry-type'], 'Point'],
      ],
      paint: {
        'circle-radius': [
    ...
    },
    {
      ...
      paint: {
        'line-emissive-strength': ['interpolate', ['exponential', 1.5], ['zoom'], 6, 0.2, 12, 0.4],
        'line-width': ['interpolate', ['exponential', 1.5], ['zoom'], 3, 0, 18, 26, 22, 260],
        'line-color': 'hsl(224, 25%, 80%)',
      },
    },
    {
      ...
      paint: {
        'line-emissive-strength': ['interpolate', ['exponential', 1.5], ['zoom'], 6, 0.4, 12, 0.5],
        'line-width': ['interpolate', ['exponential', 1.5], ['zoom'], 3, 0.8, 18, 28, 22, 280],
        'line-color': 'hsl(224, 25%, 80%)',
      },
    },
    ...
    },
    {
      ...
      layout: {},
      paint: {
        'line-gap-width': ['interpolate', ['linear'], ['zoom'], 15, 0, 16, 2],
        'line-color': [
          'interpolate',
          ['linear'],
          ['measure-light', 'brightness'],
    ...
    },
    {
      ...
      paint: {
        'line-width': ['interpolate', ['exponential', 1.5], ['zoom'], 14, 2, 22, 10],
      ...
      layout: {
        'model-id': [
          ...
          [
            ...
            ['get', 'leaf_type'],
            'needleleaved',
            ['case', ['==', ['%', ['number', ['id']], 2], 0], 'pine1-lod4', 'pine2-lod4'],
            'palm',
            'palm1-lod4',
            [
              'case',
          ...
          [
            ...
            ['get', 'leaf_type'],
            'needleleaved',
            ['case', ['==', ['%', ['number', ['id']], 2], 0], 'pine1-lod3', 'pine2-lod3'],
            'palm',
            'palm1-lod3',
            [
              'case',
          ...
          [
            ...
            ['get', 'leaf_type'],
            'needleleaved',
            ['case', ['==', ['%', ['number', ['id']], 2], 0], 'pine1-lod2', 'pine2-lod2'],
            'palm',
            'palm1-lod2',
            [
              'case',
          ...
          [
            ...
            ['get', 'leaf_type'],
            'needleleaved',
            ['case', ['==', ['%', ['number', ['id']], 2], 0], 'pine1-lod1', 'pine2-lod1'],
            'palm',
            'palm1-lod1',
            [
              'case',
    ...
    },
    {
      ...
      layout: {
        visibility: ['case', ['config', 'showRoadLabels'], 'visible', 'none'],
        'text-size': [
          'interpolate',
          ['linear'],
          ['zoom'],
        ...
        'text-font': [['concat', ['config', 'font'], ' Medium'], 'Arial Unicode MS Regular'],
        'symbol-placement': 'line',
        'text-padding': 1,
    ...
    },
    {
      ...
      layout: {
        ...
        'text-max-angle': 30,
        'text-transform': 'uppercase',
        'text-font': [['concat', ['config', 'font'], ' Medium'], 'Arial Unicode MS Bold'],
        'symbol-placement': 'line',
        'text-padding': 1,
        'text-rotation-alignment': 'map',
        'text-pitch-alignment': 'viewport',
    ...
    },
    {
      ...
      filter: [
        'all',
        ['==', ['get', 'class'], 'golf'],
        ['case', ['<=', ['pitch'], 40], true, ['<=', ['distance-from-center'], 0]],
      ],
      layout: {
        visibility: ['case', ['config', 'showPointOfInterestLabels'], 'visible', 'none'],
        'text-field': ['coalesce', ['get', 'name_en'], ['get', 'name']],
        'text-font': [['concat', ['config', 'font'], ' Medium'], 'Arial Unicode MS Regular'],
        'text-size': 12,
      },
    ...
    },
    {
      ...
      layout: {
        visibility: ['case', ['config', 'showTransitLabels'], 'visible', 'none'],
    ...
    },
    {
      ...
      'source-layer': 'building',
      minzoom: 15,
      filter: ['all', ['==', ['get', 'extrude'], 'true'], ['==', ['get', 'underground'], 'false']],
      layout: { 'fill-extrusion-edge-radius': 0.4 },
      paint: {
        'fill-extrusion-flood-light-color': ['rgba', 245, 243, 171, 1],
        ...
        'fill-extrusion-height': [
          ...
          2,
          ['all', ['==', ['get', 'height'], 3], ['==', ['get', 'type'], 'bungalow']],
          4,
          [
            'all',
            ['==', ['get', 'height'], 3],
    ...
    },
    {
      ...
      filter: ['all', ['==', ['get', 'extrude'], 'true'], ['==', ['get', 'underground'], 'false']],
      paint: {
        'fill-extrusion-color': ['match', ['id'], buildings, '#000000', 'transparent'],
        'fill-extrusion-base': ['match', ['id'], buildings, ['get', 'height'], 0],
        'fill-extrusion-height': ['match', ['id'], buildings, ['+', ['get', 'height'], 0.2], 0],
      },
    },
    {
      id: 'building-models',
      ...
      paint: {
        ...
        'model-color': [
          ...
          [
            ...
            ['measure-light', 'brightness'],
            0,
            ['hsl', ['random', 0, 90, ['id']], ['random', 20, 100, ['id']], 87],
            0.15,
            ['hsl', ['random', 200, 215, ['id']], 100, ['random', 70, 80, ['id']]],
          ],
          [
            'interpolate',
            ['linear'],
            ['measure-light', 'brightness'],
            0.16,
            ['hsla', ['random', 10, 70, ['id']], 55, ['random', 80, 90, ['id']], 1],
            0.4,
            'hsl(0, 100%, 100%)',
          ],
        ],
        'model-color-mix-intensity': [
          ...
          ['get', 'part'],
          'logo',
          ['interpolate', ['linear'], ['measure-light', 'brightness'], 0.2, 0, 0.4, 0.3],
          1,
        ],
        'model-emissive-strength': [
          ...
          ['get', 'part'],
          'door',
          ['interpolate', ['linear'], ['measure-light', 'brightness'], 0.2, 1.5, 0.4, 2.5],
          'logo',
          0.6,
          'window',
          ['random', 0.5, 0.8, ['id']],
    ...
    },
    {
      ...
      filter: [
        ...
        ['case', ['<=', ['pitch'], 45], true, ['<=', ['distance-from-center'], 0]],
        ['==', ['geometry-type'], 'LineString'],
      ],
      layout: {
        visibility: ['case', ['config', 'showPlaceLabels'], 'visible', 'none'],
        'text-font': [['concat', ['config', 'font'], ' Italic'], 'Arial Unicode MS Regular'],
        'text-max-angle': 30,
    ...
    },
    {
      ...
      filter: [
        ...
        ['has', 'name'],
        ['case', ['<=', ['pitch'], 45], true, ['<=', ['distance-from-center'], 1]],
      ],
      layout: {
        visibility: ['case', ['config', 'showRoadLabels'], 'visible', 'none'],
        'text-field': ['coalesce', ['get', 'name_en'], ['get', 'name']],
        ...
        'text-font': [['concat', ['config', 'font'], ' Bold'], 'Arial Unicode MS Bold'],
      },
      paint: {
        'icon-emissive-strength': [
          'interpolate',
    ...
    },
    {
      ...
      layout: {
        visibility: ['case', ['config', 'showRoadLabels'], 'visible', 'none'],
        'icon-image': ['match', ['get', 'type'], 'gate', 'gate', 'lift_gate', 'lift-gate', ''],
      },
      paint: {
        'icon-emissive-strength': [
          'interpolate',
    ...
    },
    {
      ...
      layout: {
        ...
        'text-size': 10,
        'text-offset': [0, -0.5],
        'text-font': [['concat', ['config', 'font'], ' Regular'], 'Arial Unicode MS Regular'],
      },
      paint: {
    ...
    },
    {
      ...
      filter: [
        ...
        ['==', ['get', 'type'], 'block'],
        ['case', ['<=', ['pitch'], 60], true, ['<=', ['distance-from-center'], 0.5]],
      ],
      layout: {
        visibility: ['case', ['config', 'showPlaceLabels'], 'visible', 'none'],
        'text-field': ['get', 'name'],
    ...
    },
    {
      ...
      layout: {
        ...
        'icon-image': [
          ...
          [
            'to-boolean',
            ['coalesce', ['image', ['concat', ['string', ['get', 'network']], '-dark']], ''],
          ],
          [
            'image',
          ...
          ['image', ['string', ['get', 'network']], ['string', ['get', 'network']]],
        ],
        'text-font': [['concat', ['config', 'font'], ' Medium'], 'Arial Unicode MS Regular'],
        ...
        'text-field': [
          ...
          [
            ...
            ['get', 'mode'],
            ['metro_rail', 'rail'],
            ['format', ['coalesce', ['get', 'name_en'], ['get', 'name']], {}],
            ['format', '', {}],
          ],
          14,
          [
    ...
    },
    {
      ...
      filter: [
        ...
        ['case', ['<=', ['pitch'], 45], true, ['<=', ['distance-from-center'], 2]],
      ],
      layout: {
        visibility: ['case', ['config', 'showTransitLabels'], 'visible', 'none'],
    ...
    },
    {
      ...
      filter: [
        ...
        [
          'match',
          ['get', 'class'],
          ['disputed_settlement_subdivision', 'settlement_subdivision'],
          ['match', ['get', 'worldview'], ['US', 'all'], true, false],
          false,
        ],
        ['<=', ['number', ['get', 'filterrank']], 3],
        ['case', ['<=', ['pitch'], 45], true, ['<=', ['distance-from-center'], 1.5]],
      ],
      layout: {
        visibility: ['case', ['config', 'showPlaceLabels'], 'visible', 'none'],
        'text-field': ['coalesce', ['get', 'name_en'], ['get', 'name']],
      ...
      layout: {
        ...
        'icon-image': [
          ...
          [
            'case',
            ['==', ['get', 'capital'], 2],
            ['image', ['string', 'border-dot-13-dark'], ['string', 'border-dot-13']],
            [
              'step',
              ['get', 'symbolrank'],
              ['image', ['string', 'dot-11-dark'], ['string', 'dot-11']],
              9,
              ['image', ['string', 'dot-10-dark'], ['string', 'dot-10']],
              11,
              ['image', ['string', 'dot-9-dark'], ['string', 'dot-9']],
            ],
          ],
          8,
          '',
